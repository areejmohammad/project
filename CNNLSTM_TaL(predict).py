...
dir_base = '/home/shared_data/UltraSuite_TaL/TaL80/core/'
...
waveglow_path = '/home/areej/waveglow_old.pt'
# waveglow_name = 'WaveGlow-EN'
...
for speaker in speakers:
    ...
    csv_files = glob.glob('models/UTI_to_STFT_CNN-improved_LSTM' + speaker + '_*.csv')
    ...
    # load fs
    melspec_scalers = pickle.load(open(melspec_model_name + '_melspec_scaler.sav', 'rb'))
    
    for basefile in ult_files['test']:
        try:
            ...
            ult[ult_test], melspec[ult_test] = create_dataset_img(ult[ult_test], melspec[ult_test], look_back = n_sequence)
            ...
            melspec_predicted = melspec_scalers.inverse_transform(melspec_predicted)
